...
$(document).ready(function() {
    ...
    function createAddButton(_toAddId) {
        thisBtnAdd = '<a style="cursor: pointer" class="add_object" data-objectid="' + _toAddId + '"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-plus"></i></button></a>';
    ...
    function createRemoveButton() {
        thisBtnRemove = '<a style="cursor: pointer;" class="remove_object"><button type="button" class="btn btn-default btn-sm" style="margin-top:8px;"><i class="fa fa-remove"></i></button></a><div style="margin-top: 10px; margin-bottom: -5px;border-top: 1px solid #e4e4e4"></div>';
