...
$(document).ready(function() {
    ...
    function createRemoveButton() {
        thisBtnRemove = '<a style="cursor: pointer;" class="remove_object"><button type="button" class="btn btn-default btn-sm" style="margin-top:8px;"><i class="fa fa-remove"></i></button></a>';
